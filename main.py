...
from auth import get_current_user, create_access_token, authenticate_user, get_user_by_email, get_user, hash_password
...
@app.get("/items", response_model=list[FashionItemResponse])
async def get_items(
    db: Session = Depends(get_db),
...
@app.post("/items", response_model=FashionItemResponse)
...
@app.get("/items/{item_id}", response_model=FashionItemResponse)
async def get_item(
    item_id: int,
    db: Session = Depends(get_db),
    current_user: Users = Depends(get_current_user)
...
@app.put("/items/{item_id}", response_model=FashionItemResponse)
...
@app.patch("/items/{item_id}", response_model=FashionItemResponse)
